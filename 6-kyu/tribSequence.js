...
const tribonacci = (signature, n) =>
{
    ...
    if (n === 0 ) return [];
const tribArray = [...signature];
while (tribArray.length < n) 
{
const lastIndex = tribArray.length - 1;
const newTribNum = tribArray[lastIndex] + tribArray[lastIndex -1] + tribArray[lastIndex -2];
tribArray.push(newTribNum)
}
return tribArray;
}
